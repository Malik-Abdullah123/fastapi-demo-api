...
class UserInput(BaseModel):
    ...
    weight:Annotated[float,Field(...,gt=0,description="weigth of the user")]
    height:Annotated[float,Field(...,gt=0,description="height if the user")]
    income_lpa:Annotated[float,Field(...,gt=0,description="Annual of the user in lpa")]
...
@app.post('/predict')
def priedict_premim(data:UserInput):
